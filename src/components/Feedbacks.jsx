...
const FeedbackCard = ({
  ...
  <motion.dev
    ...
    className='bg-[#252529] p-10 rounded-3xl xs:w-[320px] w-full'
  >
...
const Feedbacks = () => {
  return (
    <div className='mt-12 bg-[#161618]  rounded-[20px]'>
      <div
        className={`${styles.padding} bg-[#161618] rounded-2xl min-h-[300px]`}
      >
